      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center text-white">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto opacity-90">
            Join hundreds of satisfied customers who have unlocked their BMW's full potential. 
            Professional coding and upgrades with lifetime support.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
            ...
            >
              <svg className="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3a4 4 0 118 0v4m-8 0h8m-8 0H3a2 2 0 00-2 2v6a2 2 0 002 2h18a2 2 0 002-2V9a2 2 0 00-2-2h-3" />
              </svg>
              Book Your Service
            </Link>
          ...
          <div className="mt-16 pt-8 border-t border-white border-opacity-20">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-8">
              <a href="tel:+201002144865" className="flex items-center text-lg hover:text-blue-200 transition-colors">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                01002144865
              </a>
              <a href="mailto:info@bimmerfixes.com" className="flex items-center text-lg hover:text-blue-200 transition-colors">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
