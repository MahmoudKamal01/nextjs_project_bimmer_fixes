        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              ...
              Transform your BMW with expert precision and unlock its full potential.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition-colors" aria-label="Follow us on Pinterest">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/fleet/listing" className="text-gray-400 hover:text-white transition-colors">
                  Our Fleet
                </Link>
              </li>
              <li>
                <Link href="/fleet/pricing" className="text-gray-400 hover:text-white transition-colors">
                  Pricing
                </Link>
              </li>
              <li>
                <Link href="/booking/faq" className="text-gray-400 hover:text-white transition-colors">
                  FAQ
                </Link>
              </li>
              <li>
                <Link href="/booking/contact" className="text-gray-400 hover:text-white transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <span className="text-gray-400">Essential Coding</span>
              </li>
              <li>
                <span className="text-gray-400">Performance Plus</span>
              </li>
              <li>
                <span className="text-gray-400">Ultimate Experience</span>
              </li>
              <li>
                <span className="text-gray-400">Diagnostic Scan</span>
              </li>
              <li>
                <span className="text-gray-400">Custom Coding</span>
              </li>
              <li>
                <span className="text-gray-400">Performance Tune</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-400">01002144865</p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-gray-400">info@bimmerfixes.com</p>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-400">Multiple Locations</p>
