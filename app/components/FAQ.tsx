...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Ensure your BMW has at least a half tank of fuel and the battery is in good condition. Remove any aftermarket accessories that might interfere with diagnostics. If possible, have your BMW serviced recently to avoid any existing fault codes. We'll perform a complete diagnostic scan before coding to ensure your vehicle is in optimal condition.",
    },
    {
      question: "What payment methods do you accept?",
      answer:
        "We accept all major credit cards (Visa, MasterCard, American Express), PayPal, bank transfers, and cash payments. We also offer financing options for larger packages through our partner providers. Payment is typically required upon completion of services, though we may require a deposit for extensive custom coding projects.",
    },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            Everything you need to know about our BMW coding and upgrade
            services.
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <div className="bg-blue-50 rounded-2xl p-8">
            ...
            <p className="text-gray-600 mb-6">
              Our BMW coding experts are here to help. Contact us for
