...
const CarDetails = () => {
  ...
  const car = {
    ...
    description: 'The BMW M3 Competition represents the pinnacle of sports sedan engineering. With our professional coding and upgrades, this vehicle delivers an unmatched driving experience that combines luxury with track-ready performance.',
    specs: {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600 mb-6">{car.price}</p>
                <p className="text-gray-600 mb-8 leading-relaxed">{car.description}</p>

                {/* Quick Stats */}
                <div className="grid grid-cols-2 gap-6 mb-8">
                  <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                    <div className="text-2xl font-bold text-blue-600">{car.specs.power.split(' ')[0]}</div>
                    <div className="text-sm text-gray-600">Horsepower</div>
                  </div>
                  <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                    <div className="text-2xl font-bold text-blue-600">{car.specs.acceleration}</div>
                    <div className="text-sm text-gray-600">0-60 mph</div>
                  </div>
                  <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                    <div className="text-2xl font-bold text-blue-600">{car.specs.topSpeed}</div>
                    <div className="text-sm text-gray-600">Top Speed</div>
                  </div>
                  <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                    <div className="text-2xl font-bold text-blue-600">{car.specs.drivetrain.split('-')[0]}</div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="p-4 bg-blue-50 rounded-lg">
                        <h4 className="font-semibold text-blue-900 mb-2">Performance Focused</h4>
                        <p className="text-blue-700">Track-ready performance with professional coding enhancements</p>
                      </div>
                      <div className="p-4 bg-green-50 rounded-lg">
                        <h4 className="font-semibold text-green-900 mb-2">Fully Customized</h4>
                        <p className="text-green-700">Extensive BMW coding unlocks hidden features and capabilities</p>
                      </div>
                      <div className="p-4 bg-purple-50 rounded-lg">
                        <h4 className="font-semibold text-purple-900 mb-2">Premium Experience</h4>
                        <p className="text-purple-700">Luxury meets performance in this expertly tuned machine</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {Object.entries(car.specs).map(([key, value]) => (
                    <div key={key} className="p-6 bg-gray-50 rounded-lg">
                      ...
                      <p className="text-lg text-blue-600 font-semibold">{value}</p>
                    </div>
                  ))}
                </div>
              )}
              ...
              {activeTab === 'coding' && (
                <div>
                  <div className="mb-8">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">Professional BMW Coding Upgrades</h3>
                    <p className="text-gray-600 leading-relaxed">
                      This vehicle has been professionally coded to unlock hidden BMW features and enhance the driving experience. 
                      All modifications are safe, reversible, and do not affect the vehicle warranty.
                    </p>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
