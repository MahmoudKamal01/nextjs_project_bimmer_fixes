  ...
  const locations = [
    {
      id: "la",
      name: "Los Angeles, CA",
      address: "1234 BMW Boulevard, Beverly Hills",
    },
    {
      id: "miami",
      name: "Miami, FL",
      address: "5678 Ocean Drive, Miami Beach",
    },
    {
      id: "nyc",
      name: "New York, NY",
      address: "9012 Madison Avenue, Manhattan",
    },
    {
      id: "mobile",
      name: "Mobile Service",
      address: "We come to you (+$75 fee)",
    },
  ];
  ...
  const handleAdditionalServiceToggle = (serviceId: string) => {
    setFormData((prev) => ({
      ...
      appointmentInfo: {
        ...
        additionalServices: prev.appointmentInfo.additionalServices.includes(
          serviceId
        )
          ? prev.appointmentInfo.additionalServices.filter(
              (id) => id !== serviceId
            )
        ...
        <section className="bg-gradient-to-r from-gray-900 to-blue-900 text-white py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl opacity-90">
              Schedule your professional BMW coding and upgrade service in just
              a few steps
            </p>
          </div>
        </section>
                    ...
                    <div className="md:col-span-2">
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <span className="text-sm text-gray-500 ml-2">
                          Helps us prepare for your appointment
                        </span>
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="space-y-3">
                      {additionalServices.map((service) => (
                        ...
                        >
                          <input
                            type="checkbox"
                            checked={formData.appointmentInfo.additionalServices.includes(
                              service.id
                            )}
                            onChange={() =>
                    ...
                    <div className="p-6 bg-gray-50 rounded-lg">
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between">
                          <span>Date:</span>
                          <span className="font-medium">
                            {formData.appointmentInfo.date}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span>Time:</span>
                          <span className="font-medium">
                            {formData.appointmentInfo.time}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span>Location:</span>
                          <span className="font-medium">
                            {
                              locations.find(
                                (l) =>
                                  l.id === formData.appointmentInfo.location
                              )?.name
                            }
                          </span>
                        </div>
                    ...
                    <div className="p-6 bg-blue-50 rounded-lg">
                      <div className="flex items-start">
                        ...
                        <div className="text-sm text-gray-700">
                          ...
                          . I understand that this is a booking request and
                          final confirmation will be provided by Bimmer Fixes.
                        </div>
                      </div>
                    </div>
                  </div>
