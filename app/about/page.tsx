  ...
  const team = [
    {
      ...
      certifications: ['BMW Master Technician', 'ISTA/D Certified', 'E-Sys Expert'],
    ...
    },
    {
      ...
      certifications: ['BMW Software Specialist', 'ICOM Certified', 'NCS Expert'],
    ...
    },
    {
      ...
      certifications: ['BMW Service Advisor Certified', 'Customer Relations Expert'],
  ...
  const values = [
    {
      ...
      description: 'We maintain the highest standards in every BMW coding project, ensuring safe and effective modifications.'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Safety First',
      description: 'All modifications are warranty-safe and fully reversible, protecting your BMW investment.'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Innovation',
      description: 'We stay at the forefront of BMW technology, constantly updating our methods and capabilities.'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Your satisfaction is our priority. We provide lifetime support for all our coding services.'
    }
  ]
  ...
  return (
    <div className="min-h-screen">
                ...
                <div className="mb-4">
                  ...
                  <div className="space-y-1">
                    {member.certifications.map((cert, certIndex) => (
                      <span key={certIndex} className="inline-block bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full mr-1 mb-1">
                        {cert}
                      </span>
                    ))}
                  </div>
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Why Choose Bimmer Fixes?</h2>
