        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <p className="text-gray-600 mb-4">Speak directly with our BMW specialists</p>
              <a 
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <p className="text-gray-600 mb-4">Detailed questions and support</p>
              <Link 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Link href="/fleet/listing" className="group">
              <div className="bg-gray-50 rounded-xl p-6 text-center hover:bg-blue-50 transition-colors">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Vehicle Catalog</h3>
            ...
            <div className="group cursor-pointer">
              <div className="bg-gray-50 rounded-xl p-6 text-center hover:bg-purple-50 transition-colors">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Coding Guide</h3>
              ...
              <div className="bg-gray-50 rounded-xl p-6 text-center hover:bg-orange-50 transition-colors">
                <div className="bg-orange-100 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 group-hover:bg-orange-200">
                  <svg className="w-6 h-6 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a2 2 0 01-2-2v-6a2 2 0 012-2h2m-4 0V7a2 2 0 012-2h6a2 2 0 012 2v1" />
                  </svg>
                </div>
